...
class QuantLeNet(Module):
    def __init__(self):
        ...
        self.conv1 = qnn.QuantConv2d(3, 6, 5,
                                     ...
                                     weight_bit_width=1)
        self.relu1 = qnn.QuantTanh(quant_type=QuantType.BINARY, bit_width=1)
        self.conv2 = qnn.QuantConv2d(6, 16, 5,
                                     weight_quant_type=QuantType.BINARY,
                                     weight_bit_width=1)
        self.relu2 = qnn.QuantTanh(quant_type=QuantType.BINARY, bit_width=1)
        self.fc1   = qnn.QuantLinear(16*5*5, 120, bias=True,
                                     weight_quant_type=QuantType.BINARY,
                                     weight_bit_width=1)
        self.relu3 = qnn.QuantTanh(quant_type=QuantType.BINARY, bit_width=1)
        self.fc2   = qnn.QuantLinear(120, 84, bias=True,
                                     weight_quant_type=QuantType.BINARY,
                                     weight_bit_width=1)
        self.relu4 = qnn.QuantTanh(quant_type=QuantType.BINARY, bit_width=1)
