...
def train(model, modelname, optimizer, loss_fn, train_loader, val_loader, epochs=5, device="cpu"):
    ...
    for quantization in quantizations:
        ...
        if quantization == QuantType.BINARY:
            ...
            for net in Nets:
                ...
                train(net, netStr[index], optimizer, criterion, train_data_loader, validation_data_loader, 2, device)
